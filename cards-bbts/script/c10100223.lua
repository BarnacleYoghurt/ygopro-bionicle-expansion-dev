...
function c10100223.initial_effect(c)
  ...
  e1:SetDescription(aux.Stringid(10100223,0))
  ...
  e2:SetDescription(aux.Stringid(10100223,1))
...
function c10100223.target0(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	e:SetLabel(0)
	if Duel.GetLocationCount(tp,LOCATION_MZONE)>0 and Duel.IsExistingMatchingCard(c10100223.filter0,tp,LOCATION_GRAVE,0,1,nil,e,tp) and Duel.SelectYesNo(tp,aux.Stringid(10100223,2)) then
		e:SetLabel(1)
