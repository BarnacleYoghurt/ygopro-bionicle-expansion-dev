--Lightstone
function c10100154.initial_effect(c)
	--Activate
	local e1=Effect.CreateEffect(c)
	e1:SetType(EFFECT_TYPE_ACTIVATE)
	e1:SetCode(EVENT_FREE_CHAIN)
	e1:SetOperation(c10100154.operation1)
	c:RegisterEffect(e1)
end
function c10100154.operation1(e,tp,eg,ep,ev,re,r,rp)
	...
	if diff > 0 then
		...
		if diff > 1 then
			...
			if diff > 2 then
				...
				e3:SetCondition(c10100154.condition1_3)
				e3:SetOperation(c10100154.operation1_3)
				e3:SetCountLimit(1)
...
function c10100154.condition1_3(e,tp,eg,ep,ev,re,r,rp)
	return ep~=tp and r==REASON_RULE
end	
function c10100154.operation1_3(e,tp,eg,ep,ev,re,r,rp)
	Duel.Hint(HINT_CARD,0,10100154)
