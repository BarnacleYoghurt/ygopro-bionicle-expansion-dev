...
function s.target1(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then
		return Duel.IsExistingTarget(s.filter1a,tp,LOCATION_MZONE,0,1,nil)
...
function s.operation1(e,tp,eg,ep,ev,re,r,rp)
	...
	if lvc:IsRelateToEffect(e) and s.filter1a(lvc) and lvc:UpdateLevel(-1,RESET_EVENT+RESETS_STANDARD,e:GetHandler())==-1 then
